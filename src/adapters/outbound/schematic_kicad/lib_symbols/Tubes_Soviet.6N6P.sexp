		(symbol "Tubes_Soviet:6N6P"
			...
			(property "Datasheet" "https://www.tubedata.tj/sheets/049/6/6N6P.pdf"
				(at 0 0 0)
				(show_name no)
				(do_not_autoplace no)
				(hide yes)
			...
			(property "Description" "Soviet dual triode (noval base, ~mu=20)"
				(at 0 0 0)
				(show_name no)
				(do_not_autoplace no)
				(hide yes)
			...
			(property "ki_keywords" "triode valve soviet dual"
				(at 0 0 0)
				(show_name no)
				(do_not_autoplace no)
				(hide yes)
