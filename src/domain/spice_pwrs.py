"""
SPICE syntax converters (T006 Resolved #4, T102, T030).

Pure text transformations — без IO, без external state, depends only
on stdlib. В domain layer чтобы application use cases (run_spice_
import) могли использовать без adapter-layer violation.
"""
